...
setlocal makeprg=coffee\ -c\ \ \ $*\ session-tracker.coffee
setlocal matchpairs=(:),{:},[:]
setlocal nomodeline
setlocal modifiable
...
wincmd w
argglobal
if bufexists("server.coffee") | buffer server.coffee | else | edit server.coffee | endif
balt parser.coffee
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal listchars=
setlocal makeencoding=
setlocal makeprg=coffee\ -c\ \ \ $*\ server.coffee
setlocal matchpairs=(:),{:},[:]
setlocal nomodeline
setlocal modifiable
setlocal nrformats=bin,octal,hex
...
tabnext 1
badd +1 index.coffee
badd +1 parser.coffee
badd +0 session-tracker.coffee
badd +0 server.coffee
